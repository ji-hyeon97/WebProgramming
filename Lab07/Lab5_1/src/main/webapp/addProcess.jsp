...
%>
	...
	<sql:update dataSource="${dataSource}" var="resultSet">
		Insert into mfdsfood(sample_id, name, category, serving_size, calorie, water, protein, fat, carbohydrate, sugars, fiber, calcium, iron, magnesium, phosphorus, potassium, sodium, zinc, copper, manganese, selenium) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)
